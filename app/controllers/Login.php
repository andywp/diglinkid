...
class Login extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $result = Database::$database->query("SELECT `user_id`, `email`, `active`, `password`, `token_code`, `total_logins`, `type` FROM `users` WHERE `email` = '{$_POST['email']}'");
