...
class Link extends Controller {
    ...
    public function process_biolink() {
		...
		$paketData=$this->database->query("select package_expiration_date from users where user_id='".$this->link->user_id."'");
        ...
        $view_content = \Altum\Link::get_biolink($this->link, $user, $links_result,$paket)->html;
