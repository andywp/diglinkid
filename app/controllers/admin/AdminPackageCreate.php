...
class AdminPackageCreate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['monthly_price_usd'] = (float) $_POST['monthly_price_usd'];
            $_POST['annual_price_usd'] = (float) $_POST['annual_price_usd'];
            ...
            if(empty($_SESSION['error'])) {
                ...
                $stmt = Database::$database->prepare("INSERT INTO `packages` (`name`, `monthly_price`, `annual_price`, `monthly_price_usd`, `annual_price_usd`, `settings`, `is_enabled`, `date`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
                $stmt->bind_param('ssssssss', $_POST['name'], $_POST['monthly_price'], $_POST['annual_price'],$_POST['monthly_price_usd'], $_POST['annual_price_usd'],$_POST['settings'], $_POST['is_enabled'], Date::$date); 
