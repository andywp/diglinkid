    ...
    public static $routes = [
        ...
        '' => [
			...
			'payment' => [
                'controller' => 'Payment',
				 'settings' => [
                    'wrapper' => 'payment/invoice_wrapper',
                    'body_white' => false,
                ]
            ],
            /* Webhooks */
            ...
            'wa-generator' => [
                'controller' => 'WaGenerator',
				
				'settings' => [
					'wrapper' => 'wa-generator/wrapper',
                ],
            ],
			'ticket'	=> [
				'controller' => 'Ticket'
        ...
        'admin' => [
			...
			'cupon' => [
                'controller' => 'AdminCupon'
            ],
            'cupon-create' => [
                'controller' => 'AdminCuponCreate'
            ],
            'cupon-edit' => [
                'controller' => 'AdminCuponEdit'
            ],
			'ticket' => [
                'controller' => 'AdminTicket'
            ],
        ]
    ];
