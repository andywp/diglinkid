...
class Controller {
    ...
    public function run() {
        ...
        if(Router::$path == 'admin') {
            ...
            $header = new \Altum\Views\View('admin/partials/header', (array) $this);
            $this->add_view_content('header', $header->run());

            /* Establish the side menu view */
            $sidebar = new \Altum\Views\View('admin/partials/sidebar', (array) $this);
            $this->add_view_content('sidebar', $sidebar->run());

            /* Establish the top menu view */
            // $admin_menu = new \Altum\Views\View('admin/partials/admin_menu', (array) $this);
            // $this->add_view_content('admin_menu', $admin_menu->run());
 
            /* Establish the side menu view */
            // $admin_sidebar = new \Altum\Views\View('admin/partials/admin_sidebar', (array) $this);
            // $this->add_view_content('admin_sidebar', $admin_sidebar->run());
