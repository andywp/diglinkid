        ...
        <div class="container flex-lg-row flex-nowrap align-items-center">
          ...
          <div class="navbar-collapse offcanvas-nav">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                  <a class="nav-link scroll" href="#features">Dashboard</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link scroll" href="#price">WhatsApp Shortlink</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link scroll" href="#help">Support Ticket</a>
              </li>
