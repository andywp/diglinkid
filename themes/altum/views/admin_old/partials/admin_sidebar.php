...
<section class="admin-sidebar shadow-lg">
    ...
    <ul class="admin-sidebar-links">
		...
		<li class="<?= \Altum\Routing\Router::$controller == 'AdminCupon' ? 'active' : null ?>">
            <a class="nav-link d-flex flex-row " href="<?= url('admin/cupon') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fas fa-sm fa-ticket-alt" ></i></div>
                <div class="col">
                    <span class="d-inline">Cupon</span>
                </div>
            </a>
        </li>
		<li class="<?= \Altum\Routing\Router::$controller == 'AdminTicket' ? 'active' : null ?>">
            <a class="nav-link d-flex flex-row " href="<?= url('admin/ticket') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fas fa-sm fa-ticket-alt" ></i></div>
                <div class="col">
                    <span class="d-inline">Ticket</span>
                </div>
            </a>
        </li>
    </ul>
