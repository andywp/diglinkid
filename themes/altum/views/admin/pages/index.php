...
<div class="d-flex justify-content-between">
    <h1 class="h3 text-diglink"><i class="fa fa-xs fa-book text-diglink-700"></i> <?= $this->language->admin_pages_categories->header ?></h1>
...
<div class="d-flex justify-content-between">
    <h1 class="h3 text-diglink"><i class="fa fa-xs fa-file-alt text-diglink-700"></i> <?= $this->language->admin_pages->header ?></h1>
