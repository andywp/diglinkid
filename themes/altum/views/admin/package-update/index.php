                ...
                <?php else: ?>
					...
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<div class="form-group">
								...
								<input type="text" name="monthly_price_usd" class="form-control" value="<?= $data->package->monthly_price_usd ?>"  />
							</div>
						</div>
					</div>
					...
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" name="annual_price_usd" class="form-control" value="<?= $data->package->annual_price_usd ?>" />
						</div>
					</div>
