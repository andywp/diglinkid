...
<div class="d-flex justify-content-between">
    <h1 class="h3 text-diglink"><i class="fa fa-xs fa-box-open text-diglink-700"></i> <?= $this->language->admin_packages->header ?></h1>
            ...
            <table class="table table-custom">
                ...
                <?php while($row = $data->packages_result->fetch_object()): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $row->monthly_price_usd ?> USD</td>
                        <td><?= $row->annual_price_usd ?> USD</td>
