 ...
 <form name="update_biolink_" method="post" role="form">
	...
	<div class="form-group d-flex mb-3">
		<div class="float-right">
			<button class="btn btn-outline-success" type="button" onclick="addFormWhatsAPP<?= $row->link_id ?>();"> <i class="fas fa-plus-circle"></i> Tambah Field </button>
		</div>
	</div>
						...
						<div class="form-group removeclass'.$row->link_id.$i.'">
							<div class="card">
								<div class="card-body card-formdinamis">
									...
									<button title="delete" class="btn btn-danger btn-hapus" type="button" onclick="remove_fields'.$row->link_id .'(\''.$i.'\');"> <i class="fas fa-trash-alt"></i></button>
								</div>
							</div>
						</div>
						<div class="clear"></div>
