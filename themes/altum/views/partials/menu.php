        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                ...
                <?php if(\Altum\Middlewares\Authentication::check()): ?>
					...
					<li class="nav-item"><a target="_blank" class="nav-link" href="<?= url('wa-generator') ?>">WhatsApp Shortlink  </a></li>
					<li class="nav-item"><a  class="nav-link" href="<?= url('ticket') ?>">Support Ticket  </a></li>
